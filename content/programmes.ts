// The five programme pillars. Used on the homepage (short form), the Our
// Work overview page, and each programme's own page under /our-work/[slug].
// Content is grounded in "About Kupanda Collective" and the Childcare
// Workforce Concept Note.
